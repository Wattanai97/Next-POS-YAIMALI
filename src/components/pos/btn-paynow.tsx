...
const BtnPaynow = () => {
  const { holdMode, holdOrderNum, updateOrder, handlerBuy } =
    useOrderCartStore();
  ...
  return (
    <>
      <button
        ...
        className="pay-btn xxs:px-1.5 h-8 px-3 font-bold py-0.5 rounded-md dark:border dark:bordor-white dark:border-solid"
      >
